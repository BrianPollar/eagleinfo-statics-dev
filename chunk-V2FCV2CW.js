...
var OwlDateTime = class _OwlDateTime {
  ...
  constructor(dateTimeAdapter, dateTimeFormats) {
    ...
    this._id = `owl-dt-picker-${nextUniqueId2++}`;
  }
  getValidDate(obj) {
...
// projects/shared-lib/src/lib/components/input/solo-date/solo-date.component.ts
function SoloDateComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 1, ctx_r0.name), ":");
  }
}
function SoloDateComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 5)(1, "owl-date-time-inline", 6, 0);
    \u0275\u0275listener("dateSelected", function SoloDateComponent_Conditional_4_Template_owl_date_time_inline_dateSelected_1_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDateChange($event));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("@openClose", ctx_r0.popActive ? "open" : "closed");
    \u0275\u0275advance();
    \u0275\u0275property("firstDayOfWeek", 1)("pickerType", "calendar")("selectMode", ctx_r0.selectMode);
  }
}
var SoloDateComponent = class _SoloDateComponent {
  constructor(eventbus) {
    this.eventbus = eventbus;
    this.notify = new EventEmitter();
    this.notifyRange = new EventEmitter();
    this.disabled = false;
  ...
  ngOnInit() {
    const handlers = {
      clearRangeDate: () => {
        this.rangeDate = null;
        this.soleDate = void 0;
        this.notifyRange.emit(void 0);
  ...
  onRangeChange(event2) {
    ...
    let toDate = "";
    if (this.rangeDate[0]) {
      fromDate = this.rangeDate[0].getFullYear() + "-" + (this.rangeDate[0].getMonth() + 1) + "-" + this.rangeDate[0].getDate();
    }
    if (this.rangeDate[1]) {
      toDate = this.rangeDate[1].getFullYear() + "-" + (this.rangeDate[1].getMonth() + 1) + "-" + this.rangeDate[1].getDate();
    }
    this.soleDate = fromDate + " - " + toDate;
    FrontendLogger.debug("range date is ", this.rangeDate);
    if (this.rangeDate && this.rangeDate[0] && this.rangeDate[1] && this.rangeDate[0] !== this.rangeDate[1]) {
      this.popActive = false;
      this.notifyRange.emit([this.rangeDate[0], this.rangeDate[1]]);
      this.rangeDate = null;
    }
  }
  onDateChange(event2) {
    if (this.selectMode === "range") {
      this.onRangeChange(event2);
    } else {
      this.onSoloDateChange(event2);
    }
  }
  onSoloDateChange(event2) {
    FrontendLogger.debug("date selected ", event2);
    this.popActive = false;
    const date = new Date(event2);
    const newDate = date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate();
    if (newDate === this.soleDate) {
      return;
    }
    if (date.toString() === "Invalid Date") {
      FrontendLogger.error("date is INVALID", newDate);
      this.soleDate = "";
      this.notify.emit(void 0);
      return;
    }
    this.soleDate = newDate;
  ...
  static {
    this.\u0275fac = function SoloDateComponent_Factory(t) {
      return new (t || _SoloDateComponent)(\u0275\u0275directiveInject(EventbusService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SoloDateComponent, selectors: [["lib-solo-date"]], hostBindings: function SoloDateComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275listener("click", function SoloDateComponent_click_HostBindingHandler($event) {
          return ctx.onDocumentClick($event);
        }, false, \u0275\u0275resolveDocument);
      }
    }, inputs: { disabled: "disabled", name: "name", soleDate: "soleDate", placeholder: "placeholder", selectMode: "selectMode", cssClass: "cssClass" }, outputs: { notify: "notify", notifyRange: "notifyRange" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 5, vars: 6, consts: [["dateSingle", ""], [1, "form-group", 3, "click"], [1, "form-label"], [1, "picker-div"], ["readonly", "", 1, "form-control", "respect-visble-color-force", 3, "click", "ngModelChange", "keydown", "placeholder", "ngClass", "ngModel", "disabled"], [1, "date-picker-input", "absolute", "rounded-2xl", "max-w-[20px]", "!z-[9993939393939339393939393939393393939393939393933939393939393939393939393399999999999999999999999999999999]"], [3, "dateSelected", "firstDayOfWeek", "pickerType", "selectMode"]], template: function SoloDateComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1);
        \u0275\u0275listener("click", function SoloDateComponent_Template_div_click_0_listener($event) {
          return $event.stopPropagation();
        });
        \u0275\u0275template(1, SoloDateComponent_Conditional_1_Template, 4, 3, "div", 2);
        \u0275\u0275elementStart(2, "div", 3)(3, "input", 4);
        \u0275\u0275listener("click", function SoloDateComponent_Template_input_click_3_listener($event) {
          ctx.inputClicked();
          return $event.stopPropagation();
        });
        \u0275\u0275twoWayListener("ngModelChange", function SoloDateComponent_Template_input_ngModelChange_3_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.soleDate, $event) || (ctx.soleDate = $event);
          return $event;
        });
        \u0275\u0275listener("ngModelChange", function SoloDateComponent_Template_input_ngModelChange_3_listener($event) {
          return ctx.onDateChange($event);
        })("keydown", function SoloDateComponent_Template_input_keydown_3_listener($event) {
          return $event.preventDefault();
        });
        \u0275\u0275elementEnd();
        \u0275\u0275template(4, SoloDateComponent_Conditional_4_Template, 3, 4, "div", 5);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance();
        \u0275\u0275conditional(1, ctx.name ? 1 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275property("placeholder", ctx.placeholder)("ngClass", ctx.cssClass);
        \u0275\u0275twoWayProperty("ngModel", ctx.soleDate);
        \u0275\u0275property("disabled", ctx.disabled);
        \u0275\u0275advance();
        \u0275\u0275conditional(4, ctx.pickerOpen ? 4 : -1);
      }
    }, dependencies: [
      FormsModule,
      DefaultValueAccessor,
      ...
      TitleCasePipe,
      NgClass
    ], styles: ["\n\n  .owl-dt-container {\n  background: var(--app-color-white);\n  color: var(--app-color-dark);\n}\n  .owl-dt-container * {\n  color: var(--app-color-dark) !important;\n}\n  .owl-dt-container .owl-dt-calendar-cell-selected {\n  border: 1px solid var(--app-color-dark) !important;\n  background-color: var(--app-color-dark) !important;\n  color: var(--app-color-white) !important;\n}\n  .owl-dt-container .owl-dt-calendar-cell-today {\n  border: 1px solid var(--app-color-dark) !important;\n}\n/*# sourceMappingURL=https://eagleinfo-statics-dev.pages.dev/solo-date.component.css.map */"], data: { animation: [
      openClose
    ] } });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SoloDateComponent, { className: "SoloDateComponent" });
})();

export {
  SoloDateComponent
};
//# sourceMappingURL=chunk-V2FCV2CW.js.map
