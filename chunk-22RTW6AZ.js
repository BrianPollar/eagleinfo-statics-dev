...
// projects/shared-lib/src/lib/components/base/un-reliable/un-reliable-buyer/un-reliable-user-history-buyer-base.ts
var UnReliableUserHistoryListBase = class {
  constructor(windowService, toastr, router, eventbus, apNme, mainBarTitle, metaTagService, titleService) {
    ...
    this.posting = false;
    this.listCompose = new ListComposeAdminPanel(UnreliableBuyerHistory, this.eventbus, this.windowService, this.toastr);
    this.actions = [
      {
        label: "View",
        icon: "visibility",
        event: (unreliableBuyerHistory) => this.view(unreliableBuyerHistory)
      },
      {
        label: "Delete",
        icon: "delete",
        event: (unreliableBuyerHistory) => this.remove(unreliableBuyerHistory)
      }
    ];
  }
  init() {
    this.listCompose.getDataArr();
    this.mainBarTitle.title = "Unreliable Users History";
...
// projects/shared-lib/src/lib/components/base/un-reliable/un-reliable-buyer/view-un-reliable-buyer-history.ts
var ViewUnReliableUserHistoryBase = class {
  constructor(router, route, eventbus) {
    this.router = router;
    this.route = route;
    this.eventbus = eventbus;
    this.viewOneCompose = new ViewOneCompose(UnreliableBuyerHistory, { route: [""], eventName: "" }, this.router, this.route, this.eventbus);
    this.title = "View";
  }
  init() {
...
// projects/admin-panel/src/app/components/pane/un-reliable/un-reliable-user/un-reliable-user-history/view-un-reliable-user-history/view-un-reliable-user-history.component.ts
var ViewUnReliableUserHistoryComponent = class _ViewUnReliableUserHistoryComponent extends ViewUnReliableUserHistoryBase {
  constructor(router, route, eventbus) {
  ...
  closeModal() {
    this.eventbus.generalEvent$.next({
      type: "closeViewUnReliableUserHistoryModal"
    });
  }
  ngOnDestroy() {
    this.destroy();
  ...
  static {
    this.\u0275fac = function ViewUnReliableUserHistoryComponent_Factory(t) {
      return new (t || _ViewUnReliableUserHistoryComponent)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(EventbusService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ViewUnReliableUserHistoryComponent, selectors: [["app-view-un-reliable-user-history"]], standalone: true, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275StandaloneFeature], decls: 41, vars: 4, consts: [[1, "!min-h-[100vh]"], [1, "page-content"], [1, "container-fluid", "px-4"], [1, "grid", "grid-cols-1", "pb-6"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-4"], [1, "card", "!border", "!border-default-white-shade", "rounded-2xl", "shadow-md"], [1, "card-body"], [1, "flex", "flex-col", "gap-4"], [1, "text-lg", "font-semibold", "flex", "items-center", "gap-2"], [1, "material-icons-outlined", "text-blue-500"], [1, "flex", "flex-col", "gap-2"], [1, "flex", "flex-row", "gap-4", "items-center"], [1, "material-icons-outlined", "text-gray-500"], [1, "text-gray-500", "font-medium"], [1, "font-medium"]], template: function ViewUnReliableUserHistoryComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "div", 3)(4, "div", 4)(5, "div", 5)(6, "div", 6)(7, "div", 7)(8, "h4", 8)(9, "i", 9);
        \u0275\u0275text(10, "receipt_long");
        \u0275\u0275elementEnd();
        \u0275\u0275text(11, " Unreliable User History ");
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        \u0275\u0275advance(19);
        \u0275\u0275textInterpolate1(" ", (ctx.viewOneCompose.oneItem == null ? null : ctx.viewOneCompose.oneItem.buyer) || "N/A", " ");
        \u0275\u0275advance(7);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ViewUnReliableUserHistoryComponent, { className: "ViewUnReliableUserHistoryComponent" });
})();

// projects/admin-panel/src/app/components/pane/un-reliable/un-reliable-user/un-reliable-user-history/un-reliable-user-history-list/un-reliable-user-history-list.component.ts
...
var _c5 = () => ({ header: "UnreliableBuyerHistory ID", field: "_id", isDefaultField: true, sortable: true });
var _c6 = () => ({ header: "User ID", field: "user", sortable: true, removeWhen: "small" });
...
function UnReliableUserHistoryListComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 7)(1, "app-admin-date-filter-field", 11);
    \u0275\u0275listener("filter", function UnReliableUserHistoryListComponent_Conditional_8_Template_app_admin_date_filter_field_filter_1_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.listCompose.createdAtNotif($event));
    })("filterRange", function UnReliableUserHistoryListComponent_Conditional_8_Template_app_admin_date_filter_field_filterRange_1_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
var UnReliableUserHistoryListComponent = class _UnReliableUserHistoryListComponent extends UnReliableUserHistoryListBase {
  constructor(windowService, toastr, router, eventbus, apNme, mainBarTitle, metaTagService, titleService) {
  ...
  static {
    this.\u0275fac = function UnReliableUserHistoryListComponent_Factory(t) {
      return new (t || _UnReliableUserHistoryListComponent)(\u0275\u0275directiveInject(WindowService), \u0275\u0275directiveInject(ToastrService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(EventbusService), \u0275\u0275directiveInject(AppNameService), \u0275\u0275directiveInject(MainBarTitleService), \u0275\u0275directiveInject(Meta), \u0275\u0275directiveInject(Title));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UnReliableUserHistoryListComponent, selectors: [["app-un-reliable-user-history-list"]], standalone: true, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275StandaloneFeature], decls: 13, vars: 50, consts: [["title", "Unreliable User History List", 3, "breadCrumbs"], [1, "card", "!border", "!border-default-white-shade", "rounded-2xl"], [1, "card-body"], [1, "grid", "grid-cols-12", "relative"], [1, "col-span-12", "md:col-span-4", "w-[220px]"], [1, "col-span-12", "md:col-span-4", "w-[170px]"], [3, "filter", "options"], [1, "col-span-12", "md:col-span-4", "w-[170px]", "xl:block", "hidden"], [3, "paginateItems", "openExtras", "sortChange", "selectionToggle", "selectable", "selections", "currentActivePopupId", "dataArr", "limit", "offset", "count", "showingUpper", "showingLower", "currentIndex", "loading", "columns", "actions"], [3, "closed", "confirm", "multipleDelete", "showModal", "title", "message", "cancelButton", "cancelText", "confirmText", "confirmButon"], [3, "closed", "showModal", "title", "message", "cancelButton", "cancelText", "confirmText", "confirmButon"], ["placeholder", "Filter By Date Added", 3, "filter", "filterRange"]], template: function UnReliableUserHistoryListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275listener("filter", function UnReliableUserHistoryListComponent_Template_app_admin_search_field_filter_7_listener($event) {
          return ctx.listCompose.searchBy($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275template(8, UnReliableUserHistoryListComponent_Conditional_8_Template, 2, 0, "div", 7);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(9, "app-admin-table", 8);
        \u0275\u0275listener("paginateItems", function UnReliableUserHistoryListComponent_Template_app_admin_table_paginateItems_9_listener($event) {
          return ctx.listCompose.paginateItems($event);
        })("openExtras", function UnReliableUserHistoryListComponent_Template_app_admin_table_openExtras_9_listener($event) {
          return ctx.listCompose.openExtras($event);
        })("sortChange", function UnReliableUserHistoryListComponent_Template_app_admin_table_sortChange_9_listener($event) {
          return ctx.listCompose.sortBy($event.field, $event.direction);
        })("selectionToggle", function UnReliableUserHistoryListComponent_Template_app_admin_table_selectionToggle_9_listener($event) {
          return ctx.listCompose.toggleSelection($event);
        });
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(10, "app-admin-modal", 9);
        \u0275\u0275listener("closed", function UnReliableUserHistoryListComponent_Template_app_admin_modal_closed_10_listener() {
          return ctx.toggleModalDelete();
        })("confirm", function UnReliableUserHistoryListComponent_Template_app_admin_modal_confirm_10_listener($event) {
          return ctx.onModalDeleteConfirm($event);
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(11, "app-admin-modal-container", 10);
        \u0275\u0275listener("closed", function UnReliableUserHistoryListComponent_Template_app_admin_modal_container_closed_11_listener() {
          return ctx.toggleModalView();
        });
        \u0275\u0275element(12, "app-view-un-reliable-user-history");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
      ...
      AdminTopBarComponent,
      AdminModalContainerComponent,
      ViewUnReliableUserHistoryComponent
    ] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UnReliableUserHistoryListComponent, { className: "UnReliableUserHistoryListComponent" });
})();
export {
  UnReliableUserHistoryListComponent
};
//# sourceMappingURL=chunk-22RTW6AZ.js.map
