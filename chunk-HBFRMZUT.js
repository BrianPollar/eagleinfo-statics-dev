...
// projects/admin-panel/src/app/components/pane/droplet-metrics/mail-droplet/mail-droplet.component.ts
init_esm();

// projects/admin-panel/src/app/services/mail-metrics.service.ts
var MailMetricsService = class _MailMetricsService extends MetricsBase {
  ...
  static {
    this.\u0275fac = function MailMetricsService_Factory(t) {
      return new (t || _MailMetricsService)(\u0275\u0275inject(AuthService), \u0275\u0275inject(DataService));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _MailMetricsService, factory: _MailMetricsService.\u0275fac, providedIn: "root" });
  }
};

// projects/admin-panel/src/app/components/pane/droplet-metrics/mail-droplet/mail-droplet.component.ts
var _c0 = () => ({ name: "Dashboard", icon: "space_dashboard", link: "/" });
var _c1 = () => ({ name: "Mail Droplet Metrics", icon: "mail" });
var _c2 = (a0, a1) => [a0, a1];
var MailDropletComponent = class _MailDropletComponent {
  constructor(authService, mailMetricsService, metaTagService, titleService, apNme, mainBarTitle) {
    this.authService = authService;
    this.mailMetricsService = mailMetricsService;
    ...
    this.systemMetrics$ = this.mailMetricsService.systemMetrics$;
    this.socketErrors$ = this.mailMetricsService.socketError$;
  }
  ngOnInit() {
    this.mainBarTitle.title = "Mail Droplet - Droplet Metrics";
    this.titleService.setTitle(this.mainBarTitle.title + " - " + this.apNme.name);
    this.metaTagService.updateTag({
      name: "description",
      content: `Easily view and manage the details of
      an auto tax to ensure accurate
      information and effective business operations.`
    });
    if (!this.authService.mailMetricsServer) {
      throw new EagleInfoClientError("No mail metrics server found");
    }
    this.subscribeToMetrics();
    this.mailMetricsService.connect(this.authService.mailMetricsServer);
  }
  ngAfterViewInit() {
    setTimeout(() => {
  ...
  static {
    this.\u0275fac = function MailDropletComponent_Factory(t) {
      return new (t || _MailDropletComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(MailMetricsService), \u0275\u0275directiveInject(Meta), \u0275\u0275directiveInject(Title), \u0275\u0275directiveInject(AppNameService), \u0275\u0275directiveInject(MainBarTitleService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MailDropletComponent, selectors: [["app-mail-droplet"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 32, vars: 7, consts: [[1, "grid", "grid-cols-1", "pb-6"], [1, "md:flex", "items-center", "justify-between", "px-[2px]"], [1, "text-[18px]", "font-medium", "mb-sm-0", "grow", "mb-2", "md:mb-0"], [3, "breadCrumbs"], [1, "grid", "grid-cols-1", "gap-6", "gap-y-0", "2xl:gap-6", "lg:grid-cols-12"], [1, "col-span-12", "2xl:col-span-4"], [1, "card", "!border", "!border-default-white-shaderounded-xl", "!border", "!border-default-white-shade"], [1, "card-body"], [1, "card-title", "mb-4"], ["id", "cpu-chart"], [1, "col-span-12", "2xl:col-span-8"], ["id", "memory-chart"], ["id", "network-chart"], ["id", "load-chart"]], template: function MailDropletComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(12, "div", 9);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(13, "div", 10)(14, "div", 6)(15, "div", 7)(16, "h4", 8);
        \u0275\u0275text(17, "Memory Usage");
        \u0275\u0275elementEnd();
        \u0275\u0275element(18, "div", 11);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(19, "div", 4)(20, "div", 10)(21, "div", 6)(22, "div", 7)(23, "h4", 8);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MailDropletComponent, { className: "MailDropletComponent" });
})();
export {
  MailDropletComponent
};
//# sourceMappingURL=chunk-HBFRMZUT.js.map
