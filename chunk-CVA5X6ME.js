...
// projects/admin-panel/src/app/components/pane/manager-related/vendor-manager/view-vendor-manager/view-vendor-manager.component.ts
function ViewVendorMangerComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-manage-user-profile-core", 4);
    \u0275\u0275listener("inviteUser", function ViewVendorMangerComponent_Conditional_3_Template_app_manage_user_profile_core_inviteUser_0_listener() {
      \u0275\u0275restoreView(_r1);
...
var ViewVendorMangerComponent = class _ViewVendorMangerComponent {
  constructor(router, route, eventbus, toastr, apNme, mainBarTitle, metaTagService, titleService) {
    ...
    this.viewOneCompose = new ViewOneCompose(VendorManager, { route: ["/vendor-manager/update"], eventName: "updateVendorManager" }, this.router, this.route, this.eventbus);
    this.title = "View";
    this.breadCrumbs = [
      {
        name: "Dashboard",
  ...
  static {
    this.\u0275fac = function ViewVendorMangerComponent_Factory(t) {
      return new (t || _ViewVendorMangerComponent)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(EventbusService), \u0275\u0275directiveInject(ToastrService), \u0275\u0275directiveInject(AppNameService), \u0275\u0275directiveInject(MainBarTitleService), \u0275\u0275directiveInject(Meta), \u0275\u0275directiveInject(Title));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ViewVendorMangerComponent, selectors: [["app-view-vendor-manager"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 5, vars: 4, consts: [[1, "grid", "grid-cols-1", "pb-6"], [3, "title", "breadCrumbs"], [3, "user", "authUser", "inviting", "canInvite"], [3, "showModal"], [3, "inviteUser", "user", "authUser", "inviting", "canInvite"]], template: function ViewVendorMangerComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "app-admin-page-content")(1, "div", 0);
        \u0275\u0275element(2, "app-admin-back-bar", 1);
        \u0275\u0275template(3, ViewVendorMangerComponent_Conditional_3_Template, 1, 4, "app-manage-user-profile-core", 2);
        \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ViewVendorMangerComponent, { className: "ViewVendorMangerComponent" });
})();
export {
  ViewVendorMangerComponent
};
//# sourceMappingURL=chunk-CVA5X6ME.js.map
